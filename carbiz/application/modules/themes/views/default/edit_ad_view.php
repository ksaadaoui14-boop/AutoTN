...
<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5><?php echo get_post_data_by_lang($post,'title'); ?> <span><?php echo lang_key('post_ad_subtitle');?></span></span></h5>
        </div>
        <div class="col-md-5">
        <div class="breads">
        ...
        <div class="row">
                ...
                <div class="shopping-content">
                    <div class="shopping-checkout">
                                ...
                                <div class="col-md-8">
                                    <select name="brand" class="form-control" id="select-brand">
                                        ...
                                        <?php foreach ($brands->result() as $brand) {
                                            $v = (set_value('brand')!='')?set_value('brand'):$post->brand;
                                            $sel = ($v==$brand->id)?'selected="selected"':'';
                                          ?>
                                ...
                                <div class="col-md-8">
                                    <select name="model" class="form-control" id="select-model">
                                        ...
                                        <?php foreach ($models->result() as $model) {
                                            $v = (set_value('model')!='')?set_value('model'):$post->model;
                                            $sel = ($v==$model->id)?'selected="selected"':'';
                                        ?>
                                ...
                                <div class="col-md-8">
                                    <select name="year" class="form-control">
                                        ...
                                        <?php for($i=$current_year+1;$i>=1910;$i--){
                                            $v = (set_value('year')!='')?set_value('year'):$post->year;
                                            $sel = ($v==$i)?'selected="selected"':'';
                                        ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                <label>
                                    ...
                                    <?php $chk = ($chk =='' && $post->ask_for_price=='1')?'checked="checked"':$chk;?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <?php $v = (set_value('mileage')!='')?set_value('mileage'):$post->mileage;?>
                                ...
                                <div class="col-md-8">
                                    <select name="transmission" class="form-control">
                                        ...
                                        <?php foreach ($transmissions as $option) {
                                            $v = (set_value('transmission')!='')?set_value('transmission'):$post->transmission;
                                ...
                                <div class="col-md-8">
                                    <select name="condition" class="form-control">
                                        ...
                                        <?php foreach ($conditions as $option) {
                                            $v = (set_value('condition')!='')?set_value('condition'):$post->condition;
                                            $sel = ($v==$option)?'selected="selected"':'';
                                ...
                                <div class="col-md-8">
                                    <select name="fuel_type" class="form-control">
                                        ...
                                        <?php foreach ($fueltypes as $option) {
                                            $v = (set_value('fuel_type')!='')?set_value('fuel_type'):$post->fuel_type;
                                            $sel = ($v==$option)?'selected="selected"':'';
                         ...
                         <div class="form-group">
                            ...
                            <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                <label>
                                    ...
                                    <?php $chk = ($chk =='' && $post->hide_phone=='1')?'checked="checked"':$chk;?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                <label>
                                    ...
                                    <?php $chk = ($chk =='' && $post->hide_email=='1')?'checked="checked"':$chk;?>
                                ...
                                <label>
                                    ...
                                    <?php $chk = ($chk =='' && $post->disable_email_contact=='1')?'checked="checked"':$chk;?>
                                ...
                                <div class="col-md-8">
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        <?php foreach (get_all_locations_by_type('country')->result() as $row) {
                                            $v = (set_value('country')!='')?set_value('country'):$post->country;
                                            $sel = ($v==$row->id)?'selected="selected"':'';
                                            ?>
                                            <option data-name="<?php echo trim($row->name);?>" value="<?php echo $row->id;?>" <?php echo $sel;?>><?php echo lang_key($row->name);?></option>
                                        <?php }?>
                                    </select>
                                ...
                                <div class="tab-content" id="myTabContent1">
                                     ...
                                     <div id="<?php echo $lang;?>" class="tab-pane fade in <?php echo (get_current_lang()==$lang)?'active':'';?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <?php $v = (set_value('address_'.$lang)!='')?set_value('address_'.$lang):get_post_data_by_lang($post,'address',$lang);?>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php $v = (set_value('url_slug')!='')?set_value('url_slug'):$post->unique_id;?>
                        <?php $unique_id = (set_value('url_slug')!='')?set_value('url_slug'):$post->unique_id;?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="brochure">
                            <?php $v = (set_value('brochure')!='')?set_value('brochure'):$post->brochure;?>
                ...
                foreach ($fields->result() as $field) {
                    echo render_custom_field($field,$custom_data[$field->name]);
                }
                ?>
...
if(get_settings('package_settings','enable_pricing','No')=='Yes'){
    $package_id = $CI->package_model->get_post_current_package($post->id);
    $package  = $CI->package_model->get_package_by_id($package_id);
}
?>
...
jQuery(document).ready(function(){
    ...
    $('input[name="title_<?php echo default_lang();?>"]').keyup(function(){
        ...
        if(slug_val!='<?php echo $unique_id;?>')
    ...
    var sel_model = '<?php echo (set_value("model")!='')?set_value("model"):$post->model;?>';
