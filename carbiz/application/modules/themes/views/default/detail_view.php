...
if($this->config->item("sharethis_publisher_id")!=""){
?>
<script type="text/javascript">
    var pub_id = '<?php echo ($this->config->item("sharethis_publisher_id")!="")?$this->config->item("sharethis_publisher_id"):""?>';
    var switchTo5x=true;
    <?php if($isSsl){?>
                            ...
                            <div class="single-property sp-agent">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <?php 
                                        if(get_settings('content_settings','disable_location','no')=='no'){
                                        ?>
                                        <tr>
                    ...
                    <div class="s-widget">
                        ...
                        <?php if($tags != 'n/a' && $tags != ''){ ?>
                            <div class="widget-content tags">
                                ...
                                foreach ($tags as $tag) { ?>
                                    <a class="label label-color" href="<?php echo site_url('results/plainkey='.$tag)?>"><?php echo character_limiter($tag,30,'...'); ?></a>
                                <?php } ?>
                            </div>
                        <?php } ?>
                    </div>
