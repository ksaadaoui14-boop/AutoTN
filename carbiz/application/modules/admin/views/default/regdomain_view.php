...
<head>
    ...
    <title>Cubers | Admin Panel</title>
...
<body>
  <?php //include 'template/theme_settings.php';?>
    <div class="container" id="main-container">
        <div class="domreg">
          <h4>Please register your car with Cubers</h4>
          <p>You need to register you copy of car first with Cubers.</p>
