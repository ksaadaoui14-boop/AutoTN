	...
	function init()
{
     ...
     else 
     {
        ...
        foreach ($pages as $page) {
            ...
            // Correction : remplacer count($page_data) par un test adapté
            if ($page_data && isset($page_data->status) && $page_data->status == 1 && isset($page_data->show_in_menu) && $page_data->show_in_menu == 1) 
            {
	...
	function render_top_menu($id,$level=0,$alias='',$mobile_menu=FALSE)
