...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo site_url('admin/content/newlocation/country');?>" class="btn btn-success add-location"><?php echo lang_key('add_country');?></a>

      <?php if($state_active == 'yes'){ ?>
          <a href="<?php echo site_url('admin/content/newlocation/state');?>" class="btn btn-info add-location"><?php echo lang_key('add_state');?></a>
      <?php } ?>

    <a href="<?php echo site_url('admin/content/newlocation/city');?>" class="btn btn-warning add-location"><?php echo lang_key('add_city');?></a>
    ...
    <div class="box">
      ...
      <?php if(count($posts->result_array()) <= 0){ ?>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
            ...
            <form action="<?php echo site_url('admin/content/locations/0');?>" method="post" id="table-search-from" class="form-inline pull-right">
              <div class="">
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/content/editlocation/'.$row->type.'/'.$row->id);?>" class="edit-location"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/content/deletelocation/'.$curr_page.'/'.$row->id);?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a></li>
