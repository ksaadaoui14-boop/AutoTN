...
<head>
    ...
    <title><?php echo translate(get_settings('site_settings', 'site_title', 'AutoTN- car buy sell cms')); ?>
      ...
      <form id="form-login" action="<?php echo site_url('admin/auth/login/');?>" method="post">
          ...
          <div class="login-form-title">
            ...
            <div style="text-align:center">
                <img src="<?php echo base_url('assets/images/cubers.png');?>" style="height:60px; margin:20px 0px 0px;" />
            </div>
