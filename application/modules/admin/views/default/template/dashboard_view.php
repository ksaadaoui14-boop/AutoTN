...
<script type="text/javascript">
    ...
    function initialize() {
            ...
            var myLatitude = parseFloat('<?php echo get_settings("banner_settings","map_latitude", 33.8869); ?>');
            var myLongitude = parseFloat('<?php echo get_settings("banner_settings","map_longitude", 9.5375 ); ?>');
            var zoomLevel = parseInt('<?php echo get_settings("banner_settings","map_zoom",7); ?>');
...
?>
      <div class="page-title">
        ...
        <div>
          ...
          <h1><i class="fa fa-file-o"></i> <?php echo lang_key('dashboard');?> <div class="version">Cubers - version : <?php echo $config[0]->version;?></div></h1>
