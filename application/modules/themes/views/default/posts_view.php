<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5><?php echo lang_key($page_title); ?></h5>
        </div>
        <div class="col-md-5">
            <div class="breads">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                if($posts->num_rows() <= 0){
                    ...
                    foreach($posts->result() as $post){ 
                        ...
                        $desc  = get_blog_data_by_lang($post,'description');
                        ?>
                        ...
                        <div class="blog-one-item row">
                            ...
                            <div class="blog-one-img col-md-3 col-sm-3 col-xs-3">
                                <!-- Image -->
                                <a href="<?php echo site_url('show/postdetail/'.$post->id); ?>">
                                    <img src="<?php echo get_featured_photo_by_id($post->featured_img);?>" alt="" class="img-responsive img-thumbnail" />
                                </a>
                            </div>
                            <!-- blog One Content -->
                            <div class="blog-one-content col-md-9 col-sm-9 col-xs-9">
                                ...
                                <!-- Blog meta -->
                                <div class="blog-meta">
                                    <i class="fa fa-calendar"></i> &nbsp; <?php echo translatedDate($post->create_time); ?> &nbsp;
                                    <i class="fa fa-user"></i> &nbsp; <?php echo get_user_fullname_by_id($post->created_by); ?>
                                </div>
                                <!-- Paragraph -->
                                <p>
                                    <?php echo truncate(strip_tags($desc),400,
                                        '&nbsp;<a href="'.site_url('show/postdetail/'.$post->id).'">'.lang_key('view_more').'</a>',
                                        false
                                    );?>
                                </p>
                            </div>
