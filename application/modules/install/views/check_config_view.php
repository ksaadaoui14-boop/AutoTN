<?php
	...
	$files = array(	'user_uploads','user_uploads/plugins','user_uploads/plugins/tmp','uploads',
					...
					'web_config','application/config/database.php',
					'application/config/config.php', 'web_config/config.xml',
...

	{
...

		{
			...
			$error .= '<div class="alert alert-error">SITE_ROOT/'.$file.' is not writable.Please change it\'s permission before installing Carbiz[ERROR].</div>';
...

	{
		...
		<p class="lead">Everything seems to be ok. Let's install AutoTN with in 2 easy step :-)</p>
