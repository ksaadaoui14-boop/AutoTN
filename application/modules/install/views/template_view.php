...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>AutoTN Installation</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="<?php echo site_url('install');?>">AutoTN Installation</a>
	...
	<div id="footer">
      <div class="container">
        <p class="muted credit">Developed By <a href="https://www.facebook.com/CubresClub/">Cubers</a></p>
      </div>
    </div>
